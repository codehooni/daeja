...
class PrivateParkingEntity {
  ...
  factory PrivateParkingEntity.fromJson(Map<String, dynamic> json) {
    return PrivateParkingEntity(
      ...
      parkingSpots: (json['parking_spots'] as List<dynamic>?)
              ?.map((e) => ParkingSpotEntity.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      parkingZones: (json['parking_zones'] as List<dynamic>?)
              ?.map((e) => ParkingZoneEntity.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
    );
  }
